...
public struct LKFeedbackGen {
    ...
    public static func signal(_ signal: HapticSignal) {
    ...
    /// Play default System vibration
    public static func generateDefaultVibration() {
...
/// Manage system information, internally.
